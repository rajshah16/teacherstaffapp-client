...
export default function Dashboard() {
  ...
  const handlePhotoSubmit = (e) => {
    ...
    Axios.post(
      `https://teacherstaffapp.herokuapp.com/college/teacher/addNotes`,
      ...
      setsuccess([" Notes Uploaded Sucessfully"]);
    });
  };
        ...
        <TableBody>
          {announcements &&
            announcements.map((item, index) => (
              <TableRow key={index}>
                <TableCell className={classes.font}>{today.day}/{today.month}/{today.year}</TableCell>
